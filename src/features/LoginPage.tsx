...
export function LoginPage({ onSwitchToRegister, onSwitchToForgotPassword }: LoginPageProps) {
  const { signInWithGoogle, signInWithEmail, addToast } = useApp();
    ...
    <div className="min-h-screen flex items-center justify-center bg-background dark:bg-[#12121a] p-4">
      <div className="w-full max-w-md border-2 border-on-surface dark:border-[#a8a6ff] bg-surface dark:bg-[#1e1e2a] shadow-hard dark:shadow-[8px_8px_0px_0px_#a8a6ff] p-8">
        ...
        <form onSubmit={handleEmailSignIn} className="space-y-4 mb-6">
          <div>
            <label className="font-mono text-xs text-on-surface-variant dark:text-[#777584] block mb-1" htmlFor="login-email">
              Email
            </label>
          ...
          <div>
            <label className="font-mono text-xs text-on-surface-variant dark:text-[#777584] block mb-1" htmlFor="login-password">
              Password
            </label>
            <div className="relative">
            ...
            <div className="flex justify-end mt-1">
              <button
                ...
                className="font-mono text-xs text-primary dark:text-[var(--color-primary-fixed-dim-dark)] hover:underline"
              >
                Forgot password?
              </button>
            </div>
